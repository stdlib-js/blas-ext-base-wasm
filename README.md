...
```
The previous example will load the latest bundled code from the deno branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-wasm/tags). For example,

```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { dapx, dapxsum, dapxsumkbn, dapxsumors, dapxsumpw, dasumpw, dnanasumors, dnansumkbn2, dnansumpw, sapxsumkbn } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@deno/mod.js';
```
...
[@stdlib/blas/ext/base/wasm/dapx]: https://github.com/stdlib-js/blas-ext-base-wasm-dapx/tree/deno

[@stdlib/blas/ext/base/wasm/dapxsum]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsum/tree/deno

[@stdlib/blas/ext/base/wasm/dapxsumkbn]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumkbn/tree/deno

[@stdlib/blas/ext/base/wasm/dapxsumors]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumors/tree/deno

[@stdlib/blas/ext/base/wasm/dapxsumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumpw/tree/deno

[@stdlib/blas/ext/base/wasm/dasumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dasumpw/tree/deno

[@stdlib/blas/ext/base/wasm/dnanasumors]: https://github.com/stdlib-js/blas-ext-base-wasm-dnanasumors/tree/deno

[@stdlib/blas/ext/base/wasm/dnansumkbn2]: https://github.com/stdlib-js/blas-ext-base-wasm-dnansumkbn2/tree/deno

[@stdlib/blas/ext/base/wasm/dnansumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dnansumpw/tree/deno

[@stdlib/blas/ext/base/wasm/sapxsumkbn]: https://github.com/stdlib-js/blas-ext-base-wasm-sapxsumkbn/tree/deno
