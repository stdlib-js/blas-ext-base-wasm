...
```javascript
import { dapx, dapxsum, dapxsumkbn, dapxsumors, dapxsumpw, dasumpw, dnanasumors, dnansumkbn2, dnansumpw, sapxsumkbn } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@v0.1.1-deno/mod.js';
```
