...
```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/blas-ext-base-wasm/tags). For example,

```javascript
ns = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var ns = require( 'path/to/vendor/umd/blas-ext-base-wasm/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-wasm@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-wasm/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-wasm/actions/workflows/test.yml?query=branch:v0.1.1
...
[@stdlib/blas/ext/base/wasm/dapx]: https://github.com/stdlib-js/blas-ext-base-wasm-dapx/tree/umd

[@stdlib/blas/ext/base/wasm/dapxsum]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsum/tree/umd

[@stdlib/blas/ext/base/wasm/dapxsumkbn]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumkbn/tree/umd

[@stdlib/blas/ext/base/wasm/dapxsumors]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumors/tree/umd

[@stdlib/blas/ext/base/wasm/dapxsumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dapxsumpw/tree/umd

[@stdlib/blas/ext/base/wasm/dasumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dasumpw/tree/umd

[@stdlib/blas/ext/base/wasm/dnanasumors]: https://github.com/stdlib-js/blas-ext-base-wasm-dnanasumors/tree/umd

[@stdlib/blas/ext/base/wasm/dnansumkbn2]: https://github.com/stdlib-js/blas-ext-base-wasm-dnansumkbn2/tree/umd

[@stdlib/blas/ext/base/wasm/dnansumpw]: https://github.com/stdlib-js/blas-ext-base-wasm-dnansumpw/tree/umd

[@stdlib/blas/ext/base/wasm/sapxsumkbn]: https://github.com/stdlib-js/blas-ext-base-wasm-sapxsumkbn/tree/umd
