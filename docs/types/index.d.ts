...
import dapx = require( '@stdlib/blas-ext-base-wasm-dapx' );
import dapxsum = require( '@stdlib/blas-ext-base-wasm-dapxsum' );
import dapxsumkbn = require( '@stdlib/blas-ext-base-wasm-dapxsumkbn' );
import dapxsumors = require( '@stdlib/blas-ext-base-wasm-dapxsumors' );
import dapxsumpw = require( '@stdlib/blas-ext-base-wasm-dapxsumpw' );
import dasumpw = require( '@stdlib/blas-ext-base-wasm-dasumpw' );
import dnanasumors = require( '@stdlib/blas-ext-base-wasm-dnanasumors' );
import dnansumkbn2 = require( '@stdlib/blas-ext-base-wasm-dnansumkbn2' );
import dnansumpw = require( '@stdlib/blas-ext-base-wasm-dnansumpw' );
import sapxsumkbn = require( '@stdlib/blas-ext-base-wasm-sapxsumkbn' );
